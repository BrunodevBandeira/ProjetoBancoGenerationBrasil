...
public class ContaPoupanca extends Conta {
	...
	public void correcao(int niverDaConta) {
		if (diaAniversarioConta == niverDaConta) {
			System.out.println("-------> Parab√©ns o ajuste foi dado em 5%.");
			String texto = "-------> O seu novo saldo √©:  ";
			System.out.println(texto + ((getSaldo()*0.05) + getSaldo()) + "R$");

		} else {
			System.err.println("-------> A data n√£o bate, deixou de ganhar 5%.");
		}
	}
}
=======
	...
	public class ContaPoupanca extends Conta{
		    ...
		    public void correcao(int niverDaConta) {
		        if (diaAniversarioConta == niverDaConta) {
		            System.out.println("-------> ParabÈns o ajuste foi dado em 5%.");
		            String texto = "-------> O seu novo saldo È:  ";
		            System.out.println(texto + ((getSaldo()*0.05) + getSaldo()) + "R$");
...
>>>>>>> 4f4757f11e9ec6285c982524cf9e4c73277aa2d2
